...
//     return (
//         <section className="-mt-8 grid grid-cols-1 lg:grid-cols-2 w-full bg-white">
//             {/* Card 1 */}
...
//                     </p>
//                     <button onClick={openModal} className="mt-6 px-6 py-2 text-sm text-black border border-black rounded hover:bg-black hover:text-white">
//                         Saber mais
//                     </button>
//                 </div>
...
//                     </p>
//                     <button className="mt-6 px-6 py-2 text-sm text-black border border-black rounded hover:bg-black hover:text-white">
//                         Saber mais
//                     </button>
//                 </div>
...
//                     <p className="mt-4 text-black leading-7 text-justify max-w-lg">
//                         Apresentando a coleção Cups Of Kindness: Quatro drinks muito especiais tão deliciosos e refrescantes quanto lindos. Duas novas criações, Matcha Lemonade e Violet Drinl, irão se juntar à Pink Drink e Ombré Pink Drink como favoritos instantâneos do verão.
//                     </p>
//                     <button className="mt-6 px-6 py-2 text-sm text-black border border-black rounded hover:bg-black hover:text-white">
//                         Saber mais
//                     </button>
